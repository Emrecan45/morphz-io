  ...
  en: {
    privacy: {
      ...
      body: `
        ...
        <p>The game itself sets no advertising cookie and builds no player profile. The portals that host it do show their own advertising and set their own cookies, which are outside my control. On those sites the portal privacy policy applies on top of this one. On CrazyGames and Y8 the game also loads the portal software kit, which handles the advertising: see the privacy policy of <a href="https://www.crazygames.com/privacy-policy" target="_blank" rel="noopener">CrazyGames</a> and that of <a href="https://www.y8.com/privacy" target="_blank" rel="noopener">Y8</a>.</p>
        <h4>7. Children</h4>
  ...
  es: {
    privacy: {
      ...
      body: `
        ...
        <p>El juego en sí no pone ninguna cookie publicitaria ni crea ningún perfil de jugador. En cambio, los portales que lo alojan muestran su propia publicidad y ponen sus propias cookies, sobre las que no tengo control. En esos sitios se aplica la política de privacidad del portal además de esta. En CrazyGames y Y8 el juego carga además el kit de desarrollo del portal, que gestiona la publicidad: consulta la política de privacidad de <a href="https://www.crazygames.com/privacy-policy" target="_blank" rel="noopener">CrazyGames</a> y la de <a href="https://www.y8.com/privacy" target="_blank" rel="noopener">Y8</a>.</p>
        <h4>7. Menores</h4>
  ...
  pt: {
    privacy: {
      ...
      body: `
        ...
        <p>O jogo em si não coloca cookies publicitários nem cria qualquer perfil de jogador. Já os portais que o alojam mostram publicidade própria e colocam os seus próprios cookies, sobre os quais não tenho controlo. Nesses sites aplica-se a política de privacidade do portal além desta. No CrazyGames e no Y8 o jogo carrega ainda o kit de desenvolvimento do portal, que trata da publicidade: ver a política de privacidade da <a href="https://www.crazygames.com/privacy-policy" target="_blank" rel="noopener">CrazyGames</a> e a da <a href="https://www.y8.com/privacy" target="_blank" rel="noopener">Y8</a>.</p>
        <h4>7. Crianças</h4>
  ...
  ru: {
    privacy: {
      ...
      body: `
        ...
        <p>Сама игра не ставит рекламных куки и не создаёт профиль игрока. Но порталы, где она размещена, показывают собственную рекламу и ставят собственные куки, которые мне неподконтрольны. На этих сайтах вдобавок к этой действует политика конфиденциальности портала. На CrazyGames и Y8 игра дополнительно загружает набор разработчика портала, который управляет показом рекламы: смотрите политику конфиденциальности <a href="https://www.crazygames.com/privacy-policy" target="_blank" rel="noopener">CrazyGames</a> и <a href="https://www.y8.com/privacy" target="_blank" rel="noopener">Y8</a>.</p>
        <h4>7. Дети</h4>
