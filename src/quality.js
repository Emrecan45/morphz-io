...
const PROFILES = {
  ...
  floor: { pixelRatio: COARSE ? 2 : 1, samples: 0, antialias: false, shadowMap: 1536, softShadow: false, shadowSpan: 30, bloom: false, seaRows: 40, seaCols: 640, leaf: 1, spin: 55, cull: 62 },
}
...
export function reloadTier() {
  const kept = stored()
  if (kept) chooseTier(kept)
}
